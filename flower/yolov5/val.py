...
def run(
    ...
    for batch_i, (im, targets, paths, shapes) in enumerate(pbar):
        ...
        if plots and batch_i < 3:
            ...
            # pass conf_thres so plotting uses the same threshold as val run
            plot_images(im, output_to_target(out), paths, save_dir / f'val_batch{batch_i}_pred.jpg', names, min_conf=conf_thres)  # pred
